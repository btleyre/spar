# Adapted from the WILDS library
import torch
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
                 ...
                 norm_layer=None, num_channels=3, use_bias=False):
        ...
        if num_classes is not None:
            self.fc = nn.Linear(512 * block.expansion, num_classes, bias=use_bias)
...
class ResNet18(ResNet):
    def __init__(self, num_classes=10, num_channels=3, use_bias=False):
        super().__init__(
            BasicBlock, [2, 2, 2, 2], num_classes=num_classes, num_channels=num_channels, use_bias=use_bias)
