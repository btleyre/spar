...
time python3 main.py --dataset poverty --algorithm erm --data-dir ../../datasets/ --experiment_dir .. --is_kde 0 --projection --base_model_path $1 --seed 0 --proj_artifact_dir ./projection_results/base_erm_seed_0 --kde_bandwidth 0.5 --search_lr 0.001 --spar_alpha 0.999

# Or adapt with unlabeled data separate from the test set.
...
time python3 main.py --dataset poverty --algorithm mixup --data-dir ../../datasets/ --experiment_dir .. --is_kde 1 --projection --base_model_path $2 --seed 0 --proj_artifact_dir ./projection_results/base_cmixup_seed_0 --kde_bandwidth 0.5 --search_lr 0.001 --spar_alpha 0.999
